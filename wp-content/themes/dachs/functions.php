...
function bornholm_menus() {
	register_nav_menus( array(
		'header-menu' => __( 'Header Menu', 'dachs' ),
        'footer-menu' => __( 'Footer Menu', 'dachs')
	) );
}
...
function theme_enqueue_styles() {
	...
	wp_enqueue_style( 'woocommerce_child', get_stylesheet_directory_uri() . '/css/woocommerce_child.css', array(), $the_theme->get( 'Version' ) );
}
